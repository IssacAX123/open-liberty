...
/**
 * Utility methods for local Keycloak FAT support.
 */
@SuppressWarnings("restriction")
public final class KeycloakSupportUtils {

    private KeycloakSupportUtils() {
        // Utility class.
    }
    ...
    public static String getStringResponse(CloseableHttpResponse response) throws ParseException, IOException {
        ...
        Header encodingHeader = entity == null ? null : entity.getContentEncoding();
